...
<head>
  ...
  <title> Multimedia | Information</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-secondary text-light sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
       ...
       <!-- <div class="sidebar-brand-text mx-2">PT. TOYOTA BOSHOKU</div> -->
      </a>
    ...
    <li class="d-flex align-items-center justify-content-center">
      ...
      <!--
        ...
        <a class="nav-link" href="?page=pengguna">
          ...
          <span class="">Data Pengguna</span></a>
      </li>
  -->
	   ...
	   <li class="nav-item active">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=gudang">Device List</a>
            <a class="collapse-item" href="?page=jenisbarang">Device Model</a>
 <!--           <a class="collapse-item" href="?page=satuanbarang">Item Unit</a>  -->
			 <a class="collapse-item" href="?page=supplier">Pic Division</a>
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="?page=barangmasuk">Device Entry</a>
            <a class="collapse-item" href="?page=barangkeluar">Borrow List</a>
            <a class="collapse-item" href="?page=almov">Altie Movie</a>
      ...
      <div class="sidebar-heading">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_supplier"> Pic Report </a>
            <a class="collapse-item" href="?page=laporan_gudang"> Device List Report</a>
			      <a class="collapse-item" href="?page=laporan_barangmasuk"> Device Entry Report</a>
            <a class="collapse-item" href="?page=laporan_barangkeluar"> Borrow Report</a> 
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <img src="img/Divisi Multimedia.png" class="img-circle" width="80" alt="User"/></a>
        <div class="sidebar-brand-text text-light mx-11">MULTIMEDIA DIVISION</div>
        ...
        <ul class="nav pull-right top-menu">
		      ...
		      <li><a onclick="return confirm('Are you sure want to Logout?')" class="btn btn-danger" class="logout" href="logout.php">Log Out</a></li>
        </ul>
      </div>
        ...
        <div class="container-fluid">
         ...
         if ($page == "almov") {
          if ($aksi == "") {
            include "page/almov/almov.php";
          }
           if ($aksi == "tambahalmov") {
            include "page/almov/tambahalmov.php";
          }
           if ($aksi == "ubahalmov") {
            include "page/almov/ubahalmov.php";
          }
          
           if ($aksi == "hapusalmov") {
            include "page/almov/hapusalmov.php";
          }
       }
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            ...
            <br>
            <br>
            <span>Copyright &copy; 2022 . Inventory Management System</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
